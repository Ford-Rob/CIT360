...
"A hand with an Ace and a 10 value card is called a Blackjack.\n" +
"It is a winning hand unless the Dealer has a Blackjack hand as well, in which case it is a Push.\n" +
"To start, the Dealer deals each Player two cards including themselves.\n" +
"The first card will be face up and the other is face down.\n");        
    }
